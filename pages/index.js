...
<div className="flex flex-col bg-black min-h-screen w-screen pb-12 lg:bg-right lg:bg-contain lg:bg-hero-pattern-sm bg-hero-pattern-sm bg-no-repeat bg-cover bg-center">
